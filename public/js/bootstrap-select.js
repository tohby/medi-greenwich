...
(function(root, factory) {
    ...
    (function($) {
        ...
        function getSelectedOptions() {
            var selectedOptions = this.selectpicker.main.data.filter(function(
                item
            ) {
                if (item.selected) {
                    if (this.options.hideDisabled && item.disabled)
                        return false;
                    return true;
                }
        ...
        elementTemplates.selectedOption = elementTemplates.option.cloneNode(
            false
        );
        ...
        function filterHidden(item) {
            return !(
                item.hidden ||
                (this.options.hideDisabled && item.disabled)
            );
        }
        ...
        Selectpicker.prototype = {
            ...
            createView: function(isSearching, setSize, refresh) {
                ...
                function scroll(scrollTop, init) {
                    ...
                    if (that.activeIndex !== undefined) {
                        ...
                        active = (
                            that.selectpicker.main.data[that.activeIndex] || {}
                        ).element;
                        selected = (
                            that.selectpicker.main.data[that.selectedIndex] ||
                            {}
                        ).element;
            ...
            buildData: function(data, type) {
                ...
                for (
                    var len = selectOptions.length, i = startIndex;
                    i < len;
                    i++
                ) {
            ...
            buildList: function(size, searching) {
                ...
                for (
                    var len = selectData.length, i = startIndex;
                    i < len;
                    i++
                ) {
            ...
            render: function(init) {
                var that = this,
                    ...
                    selectedValues = getSelectValues.call(
                        this,
                        selectedOptions
                    ),
            ...
            clickListener: function() {
                ...
                this.$button
                    .on("focus" + EVENT_KEY, function(e) {
                        var tabindex = that.$element[0].getAttribute(
                            "tabindex"
                        );
