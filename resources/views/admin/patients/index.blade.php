    ...
    <div class="py-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="/admin/patients/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="table-settings mb-4">
            <div class="row align-items-center justify-content-between">
                <div class="col col-md-6 col-lg-3 col-xl-4">
                    <form id="patient-search-form" action="{{ action("SearchController@patients") }}" method="POST">
                        @csrf
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <div
                        ...
                        <div class="d-flex">
                            <a href="patients/{{$patient->id}}" class="fw-bold mr-3">
                                View
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <a href="patients/{{$patient->id}}/edit" class=" align-items-center fw-bold ml-2">
                                Edit
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            @unless ($patient->id === Auth::user()->id)
