                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-2">
                            <div class="logo">
                                <a href="index.html">
                                    <h1 class="strong text-dark">Medi</h1>
                                </a>
                            </div>
                        </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-xl-6">
                    <div
                        ...
                        <div class="info_button">
                            <a href="/login" class="boxed-btn3-white">Make an Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <h1 class="strong text-white">Medi</h1>
                                </a>
                            </div>
                            <p>
        ...
        <div class="popup_box ">
            <div class="popup_inner">
                ...
                <div class="row text-center">
                    <div class="col-xl-5">
                        <a href="/login" class="boxed-btn3">Sign in</a>
                    </div>
                    <div class="col-xl-2">
